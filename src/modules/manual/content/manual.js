        ...
        bloques: [
          {
            ...
            items: [
              ...
              '**Verificar el backup automático de Postgres en Dokploy (tarea del servidor, 26/8).** Sistema › Respaldos ya da la copia externa a mano (y su restauración se probó de verdad contra una base limpia), pero el backup AUTOMÁTICO del servidor es de Dokploy y hay que confirmar dos cosas mirándolo: que esté configurado con una frecuencia razonable (diario), y que UNA VEZ se haya restaurado uno para verificar que sirve — un respaldo nunca probado es una esperanza, no un respaldo. Ideal: que el destino sea externo al VPS (S3/Drive), no el mismo disco.',
