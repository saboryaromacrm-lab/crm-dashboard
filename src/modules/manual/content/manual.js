        ...
        bloques: [
          ...
          },
          {
            ...
            filas: [
              ...
              ['**Control**', 'La sesión de góndola: elegís sucursal, fecha y cantidad PRIMERO, y después el lector USB (escribe y termina en Enter — el buffer lo junta aunque el foco no esté en ningún campo) o el buscador (nombre, código o barras, también el de las presentaciones fraccionadas). Todo cae a una lista editable que se guarda de un saque; mismo producto + misma fecha se suman. La fecha pasada avisa pero DEJA: es la forma de asentar lo encontrado tarde. Cada control queda en el historial con usuario y sucursal.'],
          ...
          { t: 'ruta', texto: 'Almacén › Vencimientos (permiso almacen.vencimientos) · pestañas Panel / Control / Registros / Vencidos / Mermas / Reportes · migración 0050 (tablas, Fontana, costo congelado en movimientos)' },
        ],
      },
      {
