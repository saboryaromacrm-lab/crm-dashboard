        ...
        bloques: [
          {
            ...
            items: [
              ...
              '**La integración real con ARCA (WSFE) no está conectada.** El circuito completo de la caída ya existe y está probado (ticket provisorio con leyenda, pestaña Sin facturar, reintento): cuando se contrate el certificado, lo ÚNICO que se toca es el cuerpo de `solicitarCae()` en ventas — timeout corto y cualquier excepción vuelve como fallo, nunca como venta caída. Mientras tanto, el interruptor de ARCA en Configuración conviene dejarlo APAGADO (prendido, toda factura sale provisoria).',
