      ...
      },
      {
        ...
        bloques: [
          ...
          },
          {
            ...
            filas: [
              ['Pedido', '**Nada** — es demanda; el origen quizá ni tiene la mercadería. Se arma en **dos pestañas** (**Prod. Enteros** y **Prod. a granel**, 11/8/2026) porque son dos recorridos distintos de góndola, pero el pedido que sale es **uno solo**: la división es de la pantalla, no del documento (el botón cuenta todo y el título dice "N de M en total"). **Cada pestaña tiene su propio buscador y solo ofrece sus productos**: parado en Enteros no aparece un granel. Si lo que se buscó está en la otra, el aviso lo dice y ofrece el atajo ("hay 3 a granel · Ver Prod. a granel")'],
