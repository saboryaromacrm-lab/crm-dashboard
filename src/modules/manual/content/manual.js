    ...
    temas: [
      ...
      },
      {
        ...
        bloques: [
          {
            t: 'p',
            texto: 'La carga se parece a **leer la factura** (rediseño del 15/8/2026): se anotan **CONCEPTOS con su monto final** —"abono mensual $45.000, reconexión $8.000"— y el total es la suma, solo lectura. Si la factura A discrimina IVA, hay UN campo opcional **"IVA incluido"** para anotarlo: es informativo, no cambia el total (ya está adentro de los montos), y por atrás el neto se deriva solo para que los reportes sigan cerrando.',
          },
          {
            t: 'lista',
            items: [
              '**La LETRA viene del proveedor**: en su ficha se responde una vez "qué factura hace" (A/B/C/X) y el formulario la precarga al elegirlo — editable, porque la excepción existe. El selector la muestra al lado del nombre ("Edesur · factura A").',
