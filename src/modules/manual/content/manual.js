      ...
      },
      {
        ...
        bloques: [
          ...
          },
          {
            t: 'nota',
            tono: 'warn',
            texto: '**El usuario "Cafetería" ya existe** (rol cafeteria, creado por la migración 0048) con contraseña inicial **1234 — cambiala en Sistema › Usuarios** antes de dársela al café. El candado de visibilidad es del sistema de permisos (pantalla): como todo el CRM, la API misma sigue abierta en la red local hasta que llegue la autenticación — el bloqueante conocido del deploy.',
          },
          { t: 'ruta', texto: 'Rol Cafetería → Almacén › Pedido a la distribuidora · Admin → Almacén › Cafetería › pestaña Pedidos (+ aviso flotante) · migración 0048' },
        ],
      },
      {
