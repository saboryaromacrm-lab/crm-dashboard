        ...
        bloques: [
          ...
          },
          {
            ...
            filas: [
              ...
              ['**Anular**', 'Solo administración. Pide confirmación explicando las tres consecuencias: la mercadería **vuelve al stock** con su movimiento, deja de contar como plata vendida, y el comprobante **no se borra** (el número emitido no se recicla). Si tiene cobranzas imputadas, la API la rechaza: primero se anula el recibo'],
    ...
    temas: [
      ...
      },
      {
        ...
        bloques: [
          {
            t: 'p',
            texto: 'Llega la mercadería por **$100.000** y el flete sale **$20.000**. La cajera se lo paga al fletero **en efectivo, del cajón**. Ese flete es del proveedor —él lo reconoce restándolo de su factura—, así que a él se le terminan pagando **$80.000**. Esa plata **no es un gasto nuestro**: es un pago de SU cuenta, hecho a un tercero.',
          },
          {
            t: 'flujo',
            items: ['La cajera paga el flete', 'Tilda "Es el flete de esta entrega"', 'El administrativo carga la factura', 'Toma el flete', 'El proveedor queda debiendo el resto'],
          },
          {
            t: 'lista',
            items: [
              ...
              '**El administrativo**: al cargar la factura de esa entrega, en "Cómo se paga" aparece el flete esperando, tildado como tal y con un aviso. Tomarlo lo descuenta: la factura de $100.000 pasa a **deber $80.000**. No vuelve a mover plata — el efectivo ya salió del cajón.',
              '**Por qué hizo falta tocar el candado**: en modo "por facturas" un pago tiene que ser el saldo COMPLETO o una cuota pactada, y un flete nunca es ninguna de las dos. Antes se rechazaba, y lo peor de rechazarlo es que la plata ya había salido igual: el flete quedaba sin aplicar y la factura figuraba debiendo $100.000. Ahora **el flete queda exento de ese candado**, y también lo que se toma DENTRO del alta de la factura (ahí el total ya se valida completo por otra vía: contado + tomados + cuotas tienen que dar el total exacto). Para todo lo demás el modo sigue mandando igual que antes.',
              ...
              '**Si el proveedor reconoce MENOS de lo que se le pagó al fletero** (pagaste $20.000 y te admite $18.000): tomás $18.000 y el sistema avisa que quedaron $2.000 sin tomar. Esa diferencia es un **costo nuestro** y se cierra con un **Ajuste DEBE** en su estado de cuenta, con el motivo escrito. No se deja pasar en silencio a propósito: un resto sin aplicar que nadie mira es un saldo que después no cuadra.',
            ],
          },
          {
            t: 'nota',
          ...
          { t: 'ruta', texto: 'Ventas › Caja › Ingreso / egreso (la cajera) · Compras › Facturación (tomarlo) · Proveedores › Estados de cuenta (verlo)' },
        ],
      },
    ],
  },
        ...
        bloques: [
          ...
          },
          {
            ...
            filas: [
              ...
              ['**…son sin IVA y el IVA va aparte** (factura A)', 'Los renglones se tipean **NETOS, tal como los lista el papel**, y el IVA se **copia del pie de la factura**: se SUMA al total (neto + IVA) y cuadra centavo a centavo. Acá neto e IVA son los del comprobante, no derivados — el crédito fiscal del resumen sale exacto'],
            ],
          },
          {
            t: 'lista',
    ...
    temas: [
      {
        ...
        bloques: [
          ...
          },
          {
            ...
            filas: [
              ['**18/8/2026**', '**EL FLETE QUE SE PAGA EN EFECTIVO Y EL PROVEEDOR DESCUENTA (migración 0069).** Estaba en stand by desde ayer y lo sacaste vos explicando la dinámica exacta: llega mercadería por $100.000, el flete sale $20.000 y **la cajera se lo paga al fletero de su caja**; después, al pagarle al proveedor, se le descuenta — quedan $80.000 a pagar. Ese flete **no es un gasto nuestro**: es plata de la cuenta del proveedor pagada a un tercero, y ahora se puede DECIR que lo es. La cajera tilda **"Es el flete de esta entrega"** al registrar el egreso (Caja › Ingreso / egreso › Pago a un proveedor › Mercadería), y el administrativo lo toma al cargar la factura: la de $100.000 pasa a deber $80.000, sin volver a mover plata. **El arreglo de fondo era el candado del modo "por facturas"**, que solo acepta el saldo completo o una cuota pactada: un flete nunca es ninguna de las dos y se rechazaba, con lo peor de los dos mundos — la plata ya había salido igual y la factura seguía figurando en $100.000. Ahora el flete queda **exento de ese candado**, y también lo que se toma DENTRO del alta (ahí el total ya se valida completo por otra vía: contado + tomados + cuotas tienen que dar el total exacto). Para todo lo demás el modo sigue igual de estricto — se verificó que un pago suelto parcial se sigue rechazando con el mismo mensaje de siempre. El flete se reconoce en la bandeja de Pagos en sucursal, en el detalle de la factura y en el estado de cuenta (movimiento **Flete**, cuánto de lo pagado fueron fletes, y filtro **"Solo fletes adelantados"**). Si el proveedor reconoce menos de lo que se le pagó al fletero, la pantalla lo avisa y manda a cerrar la diferencia con un **Ajuste DEBE** con motivo — no se deja pasar en silencio. **De paso, un bug visual viejo de todo el sistema**: la regla CSS de los formularios le daba ancho completo a TODOS los input, así que cualquier casilla suelta se dibujaba como una raya de 427 px de ancho por 13 de alto. Apareció midiendo el tilde nuevo y se arregló para todos los modales de una vez'],
