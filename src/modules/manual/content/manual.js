        ...
        bloques: [
          ...
          },
          {
            ...
            items: [
              ...
              '**Si la entrega vino SUELTA** (unidades que no llegan a completar el bulto — 25/8), el selector debajo de la cantidad cambia el renglón a **"u. sueltas"**: la cantidad y el costo pasan a ser **por unidad**, y el costo se convierte solo al cambiar de modo ($/bulto ↔ $/u, mismo $/u real). La columna "Por bulto" muestra un guion: una entrega suelta **no toca el tamaño del bulto** que el proveedor tiene declarado en su formato de compra.',
