    ...
    temas: [
      {
        ...
        bloques: [
          ...
          },
          {
            ...
            filas: [
              ['**17/8/2026**', '**La lista de "Solicitar pedidos", en grilla.** Con los 169 proveedores reales, la lista de tildes había quedado en una sola columna torcida (tildes flotando, nombres a la derecha). Ahora es una **grilla de columnas** con el tilde pegado al nombre, los elegidos resaltados, y un **resumen abajo con quiénes están tildados** que no se pierde al seguir filtrando con el buscador.'],
