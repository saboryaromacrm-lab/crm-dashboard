    ...
    temas: [
      {
        ...
        bloques: [
          ...
          },
          {
            ...
            filas: [
              ['**27/8/2026**', '**EL HISTORIAL DE MOVIMIENTOS LLEGÓ A ALMACÉN, con más datos por fila** (pedido del dueño: "quiero fecha, hora, qué usuario hizo la operación y el dato que importe"). Tres piezas: **(1)** Almacén ganó la sección **Movimientos** — la misma pantalla que Compras › Historial, pegada a Existencias porque es su película (la llave es la misma que Existencias: quien ve el stock ve sus movimientos, sin cruzar de módulo). **(2)** La tabla ganó columnas: **Fecha y hora** (ya estaba la hora, ahora el encabezado lo dice), **Detalle** — el documento o motivo que generó el movimiento ("Recepción remito 0001-7 · BAVOSI", "Venta 0001-00000042 · Consumidor Final", el porqué del ajuste), con el cambio de estado cuando lo hubo (cuarentena, viaje, resolución) — **Valor** (solo las bajas por pérdida: van valuadas al costo congelado del día, el número que suma el reporte y no cambia después) y el botón **Ver** que abre la transferencia o la incidencia de la que nació la fila. La presentación se plegó abajo del producto. **(3)** Cada fila de **Existencias** ganó el botón **"Movs."**: salta al historial con ese producto y esa sucursal ya filtrados — "¿quién tocó esto y cuándo?" en un clic. Yapa del camino: el estado **en_transito** se mostraba con el nombre crudo del enum (faltaba en el mapa de etiquetas) — ahora dice **"En viaje"**. Verificado en pantalla: la sección nueva en el menú de Almacén, el salto filtrado desde una fila, y las filas completas ("26/8 08:28 p. m. · Compra · +25 kg · Recepción remito 0001-7 · BAVOSI S.A. · Lucas").'],
